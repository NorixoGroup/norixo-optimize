...
> = {
  en: { eyebrow: "Free listing audit", score: "Overall score", trust: "Trust", market: "Market", availability: "Availability", detected: "Detected", unavailable: "Not detected", insights: "Key findings", recommendations: "Priority recommendations", locked: "Full audit", comparables: "comparable listings", extractionComplete: "Complete extraction", extractionPartial: "Partial extraction", extractionBlocked: "Extraction blocked", unlock: "Unlock the full audit" },
  fr: { eyebrow: "Audit gratuit de l'annonce", score: "Score global", trust: "Confiance", market: "Marché", availability: "Disponibilité", detected: "Détectée", unavailable: "Non détectée", insights: "Constats clés", recommendations: "Recommandations prioritaires", locked: "Audit complet", comparables: "annonces comparables", extractionComplete: "Extraction complète", extractionPartial: "Extraction partielle", extractionBlocked: "Extraction bloquée", unlock: "Débloquer l'audit complet" },
  es: { eyebrow: "Auditoría gratuita del anuncio", score: "Puntuación global", trust: "Confianza", market: "Mercado", availability: "Disponibilidad", detected: "Detectada", unavailable: "No detectada", insights: "Hallazgos clave", recommendations: "Recomendaciones prioritarias", locked: "Auditoría completa", comparables: "anuncios comparables", extractionComplete: "Extracción completa", extractionPartial: "Extracción parcial", extractionBlocked: "Extracción bloqueada", unlock: "Desbloquear la auditoría completa" },
  it: { eyebrow: "Audit gratuito dell'annuncio", score: "Punteggio complessivo", trust: "Affidabilità", market: "Mercato", availability: "Disponibilità", detected: "Rilevata", unavailable: "Non rilevata", insights: "Risultati principali", recommendations: "Raccomandazioni prioritarie", locked: "Audit completo", comparables: "annunci comparabili", extractionComplete: "Estrazione completa", extractionPartial: "Estrazione parziale", extractionBlocked: "Estrazione bloccata", unlock: "Sblocca l'audit completo" },
  pt: { eyebrow: "Auditoria gratuita do anúncio", score: "Pontuação global", trust: "Confiança", market: "Mercado", availability: "Disponibilidade", detected: "Detetada", unavailable: "Não detetada", insights: "Principais conclusões", recommendations: "Recomendações prioritárias", locked: "Auditoria completa", comparables: "anúncios comparáveis", extractionComplete: "Extração completa", extractionPartial: "Extração parcial", extractionBlocked: "Extração bloqueada", unlock: "Desbloquear a auditoria completa" },
  nl: { eyebrow: "Gratis advertentie-audit", score: "Totaalscore", trust: "Vertrouwen", market: "Markt", availability: "Beschikbaarheid", detected: "Gedetecteerd", unavailable: "Niet gedetecteerd", insights: "Belangrijkste bevindingen", recommendations: "Prioritaire aanbevelingen", locked: "Volledige audit", comparables: "vergelijkbare advertenties", extractionComplete: "Volledige extractie", extractionPartial: "Gedeeltelijke extractie", extractionBlocked: "Extractie geblokkeerd", unlock: "Volledige audit ontgrendelen" },
  de: { eyebrow: "Kostenloser Inserat-Audit", score: "Gesamtbewertung", trust: "Vertrauen", market: "Markt", availability: "Verfügbarkeit", detected: "Erkannt", unavailable: "Nicht erkannt", insights: "Wichtigste Erkenntnisse", recommendations: "Priorisierte Empfehlungen", locked: "Vollständiger Audit", comparables: "vergleichbare Inserate", extractionComplete: "Vollständige Extraktion", extractionPartial: "Teilweise Extraktion", extractionBlocked: "Extraktion blockiert", unlock: "Vollständigen Audit freischalten" },
  ja: { eyebrow: "無料リスティング監査", score: "総合スコア", trust: "信頼性", market: "市場", availability: "空室状況", detected: "検出済み", unavailable: "未検出", insights: "主な所見", recommendations: "優先提案", locked: "完全監査", comparables: "件の比較対象", extractionComplete: "完全取得", extractionPartial: "部分取得", extractionBlocked: "取得ブロック", unlock: "完全監査を解除" },
  zh: { eyebrow: "免费房源审核", score: "总评分", trust: "可信度", market: "市场", availability: "可订状态", detected: "已检测", unavailable: "未检测", insights: "关键发现", recommendations: "优先建议", locked: "完整审核", comparables: "个可比房源", extractionComplete: "完整提取", extractionPartial: "部分提取", extractionBlocked: "提取受阻", unlock: "解锁完整审核" },
  ko: { eyebrow: "무료 숙소 감사", score: "종합 점수", trust: "신뢰", market: "시장", availability: "예약 가능성", detected: "감지됨", unavailable: "감지되지 않음", insights: "핵심 진단", recommendations: "우선 권장사항", locked: "전체 감사", comparables: "개 비교 숙소", extractionComplete: "전체 추출", extractionPartial: "부분 추출", extractionBlocked: "추출 차단", unlock: "전체 감사 잠금 해제" },
  ar: { eyebrow: "تدقيق مجاني للإعلان", score: "النتيجة الإجمالية", trust: "الثقة", market: "السوق", availability: "التوفر", detected: "تم الكشف", unavailable: "غير مكتشف", insights: "أهم النتائج", recommendations: "التوصيات ذات الأولوية", locked: "التدقيق الكامل", comparables: "إعلانات قابلة للمقارنة", extractionComplete: "استخراج كامل", extractionPartial: "استخراج جزئي", extractionBlocked: "الاستخراج محظور", unlock: "فتح التدقيق الكامل" },
};

const LOCKED_LABELS: Record<FreeListingAuditAvailable["lockedSections"][number], string> = {
  photos: "Photos",
    ...
    <div className="space-y-5" dir={isRtl ? "rtl" : undefined}>
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        ...
        <div className="rounded-[22px] border border-slate-200 bg-white p-4 shadow-[0_10px_24px_rgba(15,23,42,0.06)]">
          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">{labels.trust}</p>
          <p className="mt-2 text-base font-semibold text-slate-950">
            {result.trust.rating != null ? `${result.trust.rating}/5` : "—"}
          </p>
