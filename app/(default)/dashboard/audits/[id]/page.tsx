...
const auditDetailCopy = {
  en: {
    ...
    heroImpactSupportDefault: "Numerical markers: % for model-estimated conversion potential and €/month for revenue in the business projection block; /10 score in the right column.",
    ...
    estimatedBookingsAfterOptimization: "Model-estimated conversion potential after optimization",
    ...
    estimatedImpactOnBookings: "Model-estimated conversion potential",
    ...
    impactBusinessBlockIntroDefault: "Each card below uses a fixed unit: € for price, /10 for relative market score, % for model-estimated conversion potential, €/month for estimated monthly gain (additional, not total revenue).",
    ...
    conversionGainNoRange: "No percentage range is available for model-estimated conversion potential in the current report data.",
    ...
    actionReasonSeo: "SEO score + listing content optimization.",
    ...
    auditStrengthConversion: "Strong estimated conversion potential: {score}/10.",
    auditWeakDescription: "Description needs improvement: {score}/10.",
    auditWeakSeo: "SEO needs strengthening: {score}/10.",
    auditWeakConversion: "Estimated conversion potential needs strengthening: {score}/10.",
    ...
    nextStepDescription:
      "Fix the highest-priority levers first, then rerun an audit to compare the estimated score evolution.",
    ...
    scoreStatusNeedsWorkDetail: "Potential improvement lever",
    ...
    subScoreSeoImpact: "Impact: improves the listing content signals evaluated by the audit.",
    subScoreSeoPriority: "Priority: strengthen the title and useful keywords.",
    subScoreConversionNote: "Estimated conversion potential is good, but there are still levers to activate. Potential improvements mainly come from a clearer promise, stronger reassurance and more concrete content.",
    subScoreConversionFallback: "Reading to consolidate with additional data.",
    subScoreConversionImpact: "Impact: can contribute to a stronger booking decision.",
    ...
    iqaReading: "Composite index reading",
  ...
  fr: {
    ...
    heroImpactSupportDefault: "Repères chiffrés : % pour le potentiel de conversion estimé par le modèle et €/mois pour le revenu dans le bloc de projection business ; score /10 dans la colonne de droite.",
    ...
    estimatedBookingsAfterOptimization: "Potentiel de conversion estimé par le modèle après optimisation",
    ...
    estimatedImpactOnBookings: "Potentiel de conversion estimé par le modèle",
    ...
    impactBusinessBlockIntroDefault: "Chaque carte ci-dessous porte une unité fixe : € le prix, /10 le marché relatif, % le potentiel de conversion estimé par le modèle, €/mois le gain mensuel estimé (additionnel, pas le chiffre d’affaires total).",
    ...
    conversionGainNoRange: "Aucune fourchette en pourcentage n’est disponible pour le potentiel de conversion estimé par le modèle dans les données actuelles du rapport.",
    ...
    actionReasonSeo: "Score SEO + optimisation du contenu de l’annonce.",
    actionNarrativePhotos:
    ...
    auditStrengthConversion: "Potentiel de conversion estimé solide : {score}/10.",
    auditWeakDescription: "Description perfectible : {score}/10.",
    auditWeakSeo: "SEO à renforcer : {score}/10.",
    auditWeakConversion: "Potentiel de conversion estimé à renforcer : {score}/10.",
    ...
    nextStepDescription:
      "Corrigez d’abord les leviers prioritaires, puis relancez un audit pour comparer l’évolution estimée du score.",
    ...
    scoreStatusNeedsWorkDetail: "Levier d’amélioration potentiel",
    ...
    subScoreSeoImpact: "Impact : améliore les signaux de contenu de l’annonce évalués par l’audit.",
    subScoreSeoPriority: "Priorité : renforcer titre et mots-clés utiles.",
    subScoreConversionNote: "Le potentiel de conversion estimé est bon, mais il reste des leviers activables. Les améliorations potentielles viennent surtout d’une promesse plus claire, d’une meilleure réassurance et d’un contenu plus concret.",
    subScoreConversionFallback: "Lecture à consolider avec des données additionnelles.",
    subScoreConversionImpact: "Impact : peut contribuer à renforcer la décision de réserver.",
    ...
    iqaReading: "Lecture de l’indice composite",
    ...
    lqiSummaryIndicativeScore: "Le score /100 principal est indicatif : dérivé du score global /10 faute d’indice composite /100 natif dans le rapport.",
  ...
  es: {
    ...
    heroImpactSupportDefault: "Referencias numéricas: % para el potencial de conversión estimado por el modelo y €/mes para los ingresos en el bloque de proyección business; puntuación /10 en la columna derecha.",
    ...
    estimatedBookingsAfterOptimization: "Potencial de conversión estimado por el modelo tras la optimización",
    ...
    estimatedImpactOnBookings: "Potencial de conversión estimado por el modelo",
    ...
    impactBusinessBlockIntroDefault: "Cada tarjeta inferior utiliza una unidad fija: € para el precio, /10 para el mercado relativo, % para el potencial de conversión estimado por el modelo y €/mes para la ganancia mensual estimada (adicional, no los ingresos totales).",
    ...
    conversionGainNoRange: "No hay ningún rango porcentual disponible para el potencial de conversión estimado por el modelo en los datos actuales del informe.",
    ...
    actionReasonSeo: "Puntuación SEO + optimización del contenido del anuncio.",
    ...
    auditStrengthConversion: "Potencial de conversión estimado sólido: {score}/10.",
    auditWeakDescription: "Descripción mejorable: {score}/10.",
    auditWeakSeo: "SEO a reforzar: {score}/10.",
    auditWeakConversion: "Potencial de conversión estimado a reforzar: {score}/10.",
    ...
    nextStepDescription:
      "Corrige primero las palancas prioritarias y luego relanza una auditoría para comparar la evolución estimada de la puntuación.",
    ...
    scoreStatusNeedsWorkDetail: "Palanca de mejora potencial",
    ...
    subScoreSeoImpact: "Impacto: mejora las señales de contenido del anuncio evaluadas por la auditoría.",
    subScoreSeoPriority: "Prioridad: reforzar el título y las palabras clave útiles.",
    subScoreConversionNote: "El potencial de conversión estimado es bueno, pero aún hay palancas por activar. Las mejoras potenciales provienen sobre todo de una promesa más clara, más confianza y un contenido más concreto.",
    subScoreConversionFallback: "Lectura por consolidar con datos adicionales.",
    subScoreConversionImpact: "Impacto: puede contribuir a reforzar la decisión de reservar.",
    ...
    iqaReading: "Lectura del índice compuesto",
    ...
    lqiSummaryIndicativeScore: "La puntuación principal /100 es indicativa: se deriva de la puntuación global /10 porque el informe no incluye un índice compuesto /100 nativo.",
  ...
  de: {
    ...
    heroImpactSupportDefault: "Numerische Referenzen: % für das modellgeschätzte Conversion-Potenzial und €/Monat für den Umsatz im Business-Projektionsblock; /10-Score in der rechten Spalte.",
    ...
    estimatedBookingsAfterOptimization: "Vom Modell geschätztes Konversionspotenzial nach der Optimierung",
    ...
    estimatedImpactOnBookings: "Modellgeschätztes Conversion-Potenzial",
    ...
    impactBusinessBlockIntroDefault: "Jede Karte unten verwendet eine feste Einheit: € für den Preis, /10 für den relativen Marktwert, % für das modellgeschätzte Conversion-Potenzial und €/Monat für den geschätzten monatlichen Gewinn (zusätzlich, nicht der Gesamtumsatz).",
    ...
    conversionGainNoRange: "In den aktuellen Berichtsdaten ist keine prozentuale Spanne für das modellgeschätzte Conversion-Potenzial verfügbar.",
    ...
    actionReasonSeo: "SEO-Score + Optimierung des Inseratsinhalts.",
    ...
    auditStrengthConversion: "Starkes geschätztes Konversionspotenzial: {score}/10.",
    auditWeakDescription: "Beschreibung verbesserbar: {score}/10.",
    auditWeakSeo: "SEO zu stärken: {score}/10.",
    auditWeakConversion: "Geschätztes Konversionspotenzial ausbaufähig: {score}/10.",
    ...
    nextStepDescription:
      "Korrigieren Sie zuerst die wichtigsten Hebel und starten Sie anschließend erneut ein Audit, um die geschätzte Entwicklung des Scores zu vergleichen.",
    ...
    scoreStatusNeedsWorkDetail: "Potenzieller Verbesserungshebel",
    ...
    subScoreSeoImpact: "Auswirkung: verbessert die vom Audit bewerteten Inhaltssignale des Inserats.",
    subScoreSeoPriority: "Priorität: Titel und nützliche Schlüsselwörter stärken.",
    subScoreConversionNote: "Das geschätzte Konversionspotenzial ist gut, aber es bleiben noch Hebel offen. Potenzielle Verbesserungen ergeben sich vor allem durch ein klareres Versprechen, mehr Vertrauen und konkreteren Inhalt.",
    subScoreConversionFallback: "Auswertung mit zusätzlichen Daten zu konsolidieren.",
    subScoreConversionImpact: "Auswirkung: kann zu einer stärkeren Buchungsentscheidung beitragen.",
    ...
    iqaReading: "Auswertung des zusammengesetzten Index",
    ...
    lqiSummaryIndicativeScore: "Der Hauptwert /100 ist indikativ: Er wird aus dem Gesamtscore /10 abgeleitet, da im Bericht kein nativer zusammengesetzter /100-Index vorhanden ist.",
  ...
  it: {
    ...
    heroImpactSupportDefault: "Indicatori numerici: % per il potenziale di conversione stimato dal modello e €/mese per i ricavi nel blocco di proiezione business; punteggio /10 nella colonna di destra.",
    ...
    estimatedBookingsAfterOptimization: "Potenziale di conversione stimato dal modello dopo l’ottimizzazione",
    ...
    estimatedImpactOnBookings: "Potenziale di conversione stimato dal modello",
    ...
    impactBusinessBlockIntroDefault: "Ogni scheda qui sotto usa un’unità fissa: € per il prezzo, /10 per il mercato relativo, % per il potenziale di conversione stimato dal modello e €/mese per il guadagno mensile stimato (aggiuntivo, non il fatturato totale).",
    ...
    conversionGainNoRange: "Nei dati attuali del report non è disponibile alcun intervallo percentuale per il potenziale di conversione stimato dal modello.",
    ...
    actionReasonSeo: "Punteggio SEO + ottimizzazione dei contenuti dell’annuncio.",
    ...
    auditStrengthConversion: "Potenziale di conversione stimato solido: {score}/10.",
    auditWeakDescription: "Descrizione migliorabile: {score}/10.",
    auditWeakSeo: "SEO da rafforzare: {score}/10.",
    auditWeakConversion: "Potenziale di conversione stimato da rafforzare: {score}/10.",
    ...
    nextStepDescription:
      "Correggi prima le leve prioritarie, poi rilancia un audit per confrontare l’evoluzione stimata del punteggio.",
    ...
    scoreStatusNeedsWorkDetail: "Leva di miglioramento potenziale",
    ...
    subScoreSeoImpact: "Impatto: migliora i segnali di contenuto dell’annuncio valutati dall’audit.",
    subScoreSeoPriority: "Priorità: rafforzare titolo e parole chiave utili.",
    subScoreConversionNote: "Il potenziale di conversione stimato è buono, ma restano leve da attivare. I miglioramenti potenziali derivano soprattutto da una promessa più chiara, maggiore rassicurazione e contenuti più concreti.",
    subScoreConversionFallback: "Lettura da consolidare con dati aggiuntivi.",
    subScoreConversionImpact: "Impatto: può contribuire a rafforzare la decisione di prenotare.",
    ...
    iqaReading: "Lettura dell’indice composito",
    ...
    lqiSummaryIndicativeScore: "Il punteggio principale /100 è indicativo: deriva dal punteggio globale /10 poiché nel report non è disponibile un indice composito /100 nativo.",
  ...
  pt: {
    ...
    heroImpactSupportDefault: "Referências numéricas: % para o potencial de conversão estimado pelo modelo e €/mês para a receita no bloco de projeção business; pontuação /10 na coluna da direita.",
    ...
    estimatedBookingsAfterOptimization: "Potencial de conversão estimado pelo modelo após a otimização",
    ...
    estimatedImpactOnBookings: "Potencial de conversão estimado pelo modelo",
    ...
    impactBusinessBlockIntroDefault: "Cada cartão abaixo usa uma unidade fixa: € para o preço, /10 para o mercado relativo, % para o potencial de conversão estimado pelo modelo e €/mês para o ganho mensal estimado (adicional, não a receita total).",
    ...
    conversionGainNoRange: "Não existe um intervalo percentual disponível para o potencial de conversão estimado pelo modelo nos dados atuais do relatório.",
    ...
    actionReasonSeo: "Pontuação SEO + otimização do conteúdo do anúncio.",
    ...
    auditStrengthSeo: "SEO sólido: {score}/10.",
    auditStrengthConversion: "Potencial de conversão estimado sólido: {score}/10.",
    auditWeakDescription: "Descrição a melhorar: {score}/10.",
    auditWeakSeo: "SEO a reforçar: {score}/10.",
    auditWeakConversion: "Potencial de conversão estimado a reforçar: {score}/10.",
    ...
    nextStepDescription:
      "Corrija primeiro as alavancas prioritárias e, em seguida, relance uma auditoria para comparar a evolução estimada da pontuação.",
    ...
    scoreStatusNeedsWorkDetail: "Alavanca de melhoria potencial",
    ...
    subScoreSeoImpact: "Impacto: melhora os sinais de conteúdo do anúncio avaliados pela auditoria.",
    subScoreSeoPriority: "Prioridade: reforçar o título e as palavras-chave úteis.",
    subScoreConversionNote: "O potencial de conversão estimado é bom, mas ainda há alavancas a ativar. As melhorias potenciais vêm sobretudo de uma promessa mais clara, mais confiança e conteúdo mais concreto.",
    subScoreConversionFallback: "Leitura a consolidar com dados adicionais.",
    subScoreConversionImpact: "Impacto: pode contribuir para reforçar a decisão de reservar.",
    ...
    iqaReading: "Leitura do índice composto",
    ...
    lqiSummaryIndicativeScore: "A pontuação principal /100 é indicativa: deriva da pontuação global /10 porque não existe um índice composto /100 nativo no relatório.",
  ...
  nl: {
    ...
    heroImpactSupportDefault: "Cijfermatige referenties: % voor het door het model geschatte conversiepotentieel en €/maand voor de omzet in het businessprojectieblok; /10-score in de rechterkolom.",
    ...
    estimatedBookingsAfterOptimization: "Door het model geschat conversiepotentieel na optimalisatie",
    ...
    estimatedImpactOnBookings: "Door het model geschat conversiepotentieel",
    ...
    impactBusinessBlockIntroDefault: "Elke kaart hieronder gebruikt een vaste eenheid: € voor de prijs, /10 voor de relatieve markt, % voor het door het model geschatte conversiepotentieel en €/maand voor de geschatte maandelijkse winst (extra, niet de totale omzet).",
    ...
    conversionGainNoRange: "Er is in de huidige rapportgegevens geen procentueel bereik beschikbaar voor het door het model geschatte conversiepotentieel.",
    ...
    actionReasonSeo: "SEO-score + optimalisatie van de advertentie-inhoud.",
    ...
    auditStrengthConversion: "Sterk geschat conversiepotentieel: {score}/10.",
    auditWeakDescription: "Beschrijving te verbeteren: {score}/10.",
    auditWeakSeo: "SEO te versterken: {score}/10.",
    auditWeakConversion: "Geschat conversiepotentieel te versterken: {score}/10.",
    ...
    nextStepDescription:
      "Corrigeer eerst de belangrijkste hefbomen en start daarna opnieuw een audit om de geschatte ontwikkeling van de score te vergelijken.",
    ...
    scoreStatusNeedsWorkDetail: "Potentiële verbeterhefboom",
    ...
    subScoreSeoImpact: "Impact: verbetert de inhoudssignalen van de advertentie die door de audit worden beoordeeld.",
    subScoreSeoPriority: "Prioriteit: titel en nuttige zoekwoorden versterken.",
    subScoreConversionNote: "Het geschatte conversiepotentieel is goed, maar er zijn nog hefbomen te activeren. Potentiële verbeteringen komen vooral van een duidelijkere belofte, meer geruststelling en concretere inhoud.",
    subScoreConversionFallback: "Lezing te consolideren met extra gegevens.",
    subScoreConversionImpact: "Impact: kan bijdragen aan een sterkere boekingsbeslissing.",
    ...
    iqaReading: "Lezing van de samengestelde index",
    ...
    lqiSummaryIndicativeScore: "De hoofdscore /100 is indicatief: afgeleid van de algemene /10-score omdat er in het rapport geen native samengestelde /100-index beschikbaar is.",
  ...
  ja: {
    ...
    heroImpactSupportDefault: "数値の目安: モデル推定のコンバージョン可能性は %、月次収益はビジネス予測ブロックで €/月、右列のスコアは /10 です。",
    ...
    estimatedBookingsAfterOptimization: "最適化後のモデル推定コンバージョン可能性",
    projectionBase: "予測基盤",
    ...
    estimatedImpactOnBookings: "モデル推定のコンバージョン可能性",
    impactBusinessBlockIntroOutOfSegment: "価格セグメント外の比較物件が保持されました — 品質、内容、視覚コンバージョンに関する提案のみが信頼して解釈できます。",
    impactBusinessBlockIntroDefault: "以下の各カードは固定単位を使います: 価格は €、相対市場スコアは /10、モデル推定のコンバージョン可能性は %、推定月次増益は €/月（総売上ではなく追加分）です。",
    ...
    conversionGainNoRange: "現在のレポートデータでは、モデル推定のコンバージョン可能性に利用できるパーセンテージ範囲はありません。",
    ...
    actionReasonSeo: "SEO スコア + リスティング内容の最適化。",
    ...
    auditStrengthConversion: "推定コンバージョン可能性が高い: {score}/10。",
    auditWeakDescription: "説明に改善が必要: {score}/10。",
    auditWeakSeo: "SEO の強化が必要: {score}/10。",
    auditWeakConversion: "推定コンバージョン可能性に改善余地あり: {score}/10。",
    ...
    nextStepDescription: "まず優先度の高い改善項目を修正し、その後に監査を再実行して推定スコアの変化を比較してください。",
    ...
    scoreStatusNeedsWorkDetail: "潜在的な改善ポイント",
    scoreStatusWeak: "弱い",
    ...
    subScoreSeoImpact: "影響: 監査で評価されるリスティングのコンテンツシグナルを改善します。",
    subScoreSeoPriority: "優先事項: タイトルと有用キーワードを強化する。",
    subScoreConversionNote: "推定コンバージョン可能性は良好ですが、まだ改善できる項目があります。潜在的な改善は、より明確な訴求、より強い安心感、より具体的な内容から得られます。",
    subScoreConversionFallback: "追加データで読み取りを補強する必要があります。",
    subScoreConversionImpact: "影響: 予約判断を後押しする可能性があります。",
    subScoreConversionPriority: "優先事項: 安心感と明確さを改善する。",
    iqaBusinessIndicator: "ビジネス指標",
    iqaPerceivedListingQuality: "掲載・市場の複合指標",
    iqaReading: "複合指標の読み取り",
    ...
    lqiSummaryIndicativeScore: "主要な /100 スコアは参考値です。レポートにネイティブの /100 複合指標がないため、総合 /10 スコアから導出しています。",
  ...
  zh: {
    ...
    heroImpactSupportDefault: "数值参考：% 表示模型估算的转化潜力，业务预测区块中的月收益以 €/月表示，右侧栏评分为 /10。",
    ...
    estimatedBookingsAfterOptimization: "优化后的模型估算转化潜力",
    projectionBase: "预测基础",
    ...
    estimatedImpactOnBookings: "模型估算的转化潜力",
    impactBusinessBlockIntroOutOfSegment: "保留了超出价格细分范围的竞品 — 只有质量、内容和视觉转化建议可以被可靠解读。",
    impactBusinessBlockIntroDefault: "下方每张卡片都使用固定单位：€ 表示价格，/10 表示相对市场得分，% 表示模型估算的转化潜力，€/月 表示预估月收益（增量而非总收入）。",
    ...
    conversionGainNoRange: "当前报告数据中没有可用于模型估算转化潜力的百分比范围。",
    ...
    scoreStatusNeedsWorkDetail: "潜在改进杠杆",
    scoreStatusWeak: "弱",
    ...
    subScoreSeoImpact: "影响：改善审计所评估的房源内容信号。",
    subScoreSeoPriority: "优先事项：加强标题和有用关键词。",
    subScoreConversionNote: "估算转化潜力不错，但仍有可改进的杠杆。潜在改进主要来自更清晰的价值主张、更强的信任感和更具体的内容。",
    subScoreConversionFallback: "该解读需要更多数据来补强。",
    subScoreConversionImpact: "影响：可能有助于增强预订决策。",
    ...
    lqiSummaryIndicativeScore: "主 /100 分数仅供参考：由于报告中没有原生 /100 综合指数，因此从总体 /10 分数推导而来。",
  ...
  ko: {
    ...
    heroImpactSupportDefault: "수치 기준: 모델 추정 전환 잠재력은 %, 월 수익은 비즈니스 예측 블록에서 €/월, 오른쪽 열 점수는 /10입니다.",
    ...
    estimatedBookingsAfterOptimization: "최적화 후 모델이 추정한 전환 잠재력",
    ...
    estimatedImpactOnBookings: "모델 추정 전환 잠재력",
    impactBusinessBlockIntroOutOfSegment: "가격 세그먼트 밖의 비교 숙소가 유지되었습니다 — 품질, 콘텐츠, 시각적 전환 관련 권장사항만 신뢰 있게 해석할 수 있습니다.",
    impactBusinessBlockIntroDefault: "아래 각 카드는 고정 단위를 사용합니다. 가격은 €, 상대 시장 점수는 /10, 모델 추정 전환 잠재력은 %, 예상 월간 수익은 €/월(총매출이 아닌 추가 수익)입니다.",
    ...
    conversionGainNoRange: "현재 보고서 데이터에는 모델 추정 전환 잠재력에 사용할 수 있는 백분율 범위가 없습니다.",
    ...
    actionReasonSeo: "SEO 점수 + 숙소 콘텐츠 최적화.",
    ...
    auditStrengthConversion: "높은 추정 전환 잠재력: {score}/10.",
    auditWeakDescription: "설명 개선 필요: {score}/10.",
    auditWeakSeo: "SEO 강화 필요: {score}/10.",
    auditWeakConversion: "추정 전환 잠재력 개선 필요: {score}/10.",
    ...
    nextStepDescription: "먼저 우선순위가 높은 개선 항목을 수정한 뒤 감사를 다시 실행해 추정 점수의 변화를 비교하세요.",
    ...
    scoreStatusNeedsWorkDetail: "잠재적 개선 요소",
    scoreStatusWeak: "약함",
    ...
    subScoreSeoImpact: "영향: 감사에서 평가하는 숙소 콘텐츠 신호를 개선합니다.",
    subScoreSeoPriority: "우선순위: 제목과 유용한 키워드를 강화하기.",
    subScoreConversionNote: "추정 전환 잠재력은 좋지만, 아직 개선할 요소가 남아 있습니다. 잠재적 개선은 더 명확한 가치 제안, 더 큰 신뢰감, 더 구체적인 콘텐츠에서 나옵니다.",
    subScoreConversionFallback: "추가 데이터로 해석을 보강해야 합니다.",
    subScoreConversionImpact: "영향: 예약 결정을 강화하는 데 기여할 수 있습니다.",
    ...
    lqiSummaryIndicativeScore: "주요 /100 점수는 참고값입니다. 보고서에 네이티브 /100 복합 지수가 없기 때문에 전체 /10 점수에서 파생했습니다.",
  ...
  ar: {
    ...
    heroImpactSupportDefault: "المؤشرات الرقمية: % لإمكانات التحويل المقدّرة بواسطة النموذج و €/شهريًا للإيراد ضمن قسم التوقعات التجارية؛ ودرجة /10 في العمود الأيمن.",
    ...
    estimatedBookingsAfterOptimization: "إمكانات التحويل المقدّرة بواسطة النموذج بعد التحسين",
    ...
    estimatedImpactOnBookings: "إمكانات التحويل المقدّرة بواسطة النموذج",
    ...
    impactBusinessBlockIntroDefault: "كل بطاقة أدناه تستخدم وحدة ثابتة: € للسعر، /10 للدرجة السوقية النسبية، % لإمكانات التحويل المقدّرة بواسطة النموذج، و €/شهريًا للربح الشهري التقديري (إضافي وليس إجمالي الإيراد).",
    ...
    conversionGainNoRange: "لا يتوفر نطاق نسبي لإمكانات التحويل المقدّرة بواسطة النموذج في بيانات التقرير الحالية.",
    ...
    actionReasonSeo: "درجة SEO + تحسين محتوى الإعلان.",
    ...
    auditStrengthConversion: "إمكانات تحويل تقديرية قوية: {score}/10.",
    auditWeakDescription: "الوصف يحتاج إلى تحسين: {score}/10.",
    auditWeakSeo: "SEO يحتاج إلى تعزيز: {score}/10.",
    auditWeakConversion: "إمكانات التحويل التقديرية تحتاج إلى تعزيز: {score}/10.",
    ...
    nextStepDescription: "ابدأ أولًا بتصحيح عناصر التحسين ذات الأولوية، ثم أعد تشغيل التدقيق لمقارنة تطور الدرجة التقديرية.",
    ...
    seoPerformance: "قوة تحسين محركات البحث",
    ...
    scoreStatusNeedsWorkDetail: "رافعة تحسين محتملة",
    ...
    subScoreSeoImpact: "الأثر: يحسن إشارات محتوى الإعلان التي يقيّمها التدقيق.",
    subScoreSeoPriority: "الأولوية: تعزيز العنوان والكلمات المفتاحية المفيدة.",
    subScoreConversionNote: "إمكانات التحويل التقديرية جيدة، لكن ما تزال هناك عناصر قابلة للتحسين. تأتي التحسينات المحتملة أساسًا من عرض قيمة أوضح، وثقة أكبر، ومحتوى أكثر ملموسية.",
    subScoreConversionFallback: "القراءة تحتاج إلى تدعيم ببيانات إضافية.",
    subScoreConversionImpact: "الأثر: يمكن أن يساهم في تعزيز قرار الحجز.",
    ...
    iqaReading: "قراءة المؤشر المركب",
    ...
    lqiSummaryIndicativeScore: "الدرجة الرئيسية /100 إرشادية: مشتقة من الدرجة الإجمالية /10 لأنه لا يوجد مؤشر مركب /100 أصلي في التقرير.",
...
export default function AuditDetailPage() {
  ...
  /** Carte latérale « Impact estimé » : % heuristique de potentiel de conversion, soumis aux gardes business UI. */
