...
function getAuditsCopy(locale: Locale) {
  ...
  if (locale === "ja") {
    return {
      ...
      heading: "パフォーマンス監査",
      subtitle:
        "掲載を分析し、予約を増やすための高インパクトなアクションを特定します。",
      headerDescription:
        "掲載の品質を時系列で追跡し、結果を比較し、次の最適化アクションの優先順位を決めましょう。",
      identity: "ワークスペース情報",
      owner: "オーナープロフィール",
      notProvided: "未入力",
      auditsCount: "完了した監査",
      averageScore: "平均スコア",
      lastAudit: "最新の監査",
      improvementPotential: "成長機会",
      improvementPotentialText:
        "掲載を改善した場合に期待できる推定伸び幅です。",
      estimatedImpact: "推定インパクト",
      freeLimitReached: "無料プランの上限に達しました",
      freeLimitHelper: "Pro にアップグレードして無制限の監査を解放しましょう。",
      unlockPro: "Pro にアップグレード",
      proBadge: "Proで利用可能",
      proActive: "Proプラン有効",
      creditsActiveLabel: "有効なクレジット",
      creditsAvailableSuffix: "利用可能な監査",
      creditsStatusSubtext: "すぐに新しい監査を開始できる状態です",
      planVersusCreditsHint:
        "このワークスペースの請求プランです。残りの監査クレジットではありません（Billing を参照）。",
      creditsAvailableLabel: "利用可能なクレジット",
      noCreditsAvailable: "利用可能なクレジットはありません",
      limitReachedCta: "上限に達しました",
      aiInsights: "AI インサイト",
      summaryTitle: "パフォーマンス概要",
      summaryText:
        "監査履歴を使って、どの掲載に今すぐ対応すべきか、どこで最も簡単にコンバージョン改善を得られるかを見極めましょう。",
      insightsTitle: "インサイトと推奨事項",
      insightsText:
        "可視性、コンバージョン、パフォーマンスの改善につながりやすいアクションから始めましょう。",
      recommendedActions: "推奨アクション",
      insightOne: "メイン写真を最適化する",
      insightTwo: "掲載タイトルを改善する",
      insightThree: "より目立つ設備を追加する",
      limitedRecommendations: "さらに詳しい分析を見る",
      ctaLaunchAudit: "監査を開始",
      ctaLaunchAuditLastCredit: "監査を開始（最後のクレジット）",
      ctaLaunchAuditTwoLeft: "監査を開始（残り2件）",
      ctaBuyAudits: "監査を購入",
      ctaConsumesCredit: "1クレジット消費",
      ctaBuyAuditsHelper: "Billing ページでパックまたは監査ごとの支払いを選択してください。",
      relaunchAuditLastCredit: "監査を再実行（最後のクレジット）",
      relaunchAuditTwoLeft: "監査を再実行（残り2件）",
      ctaHelper: "予約数を増やすアクションを特定しましょう。",
      reportsTitle: "利用可能なレポート",
      linkedListingColumn: "関連する掲載",
      linkedListingHint: "この掲載のパフォーマンスレポート",
      showingReportsFor: "表示中のレポート",
      showAllReports: "すべてのレポートを表示",
      noReportsForFilteredListing: "このワークスペースでは、この掲載に対するレポートがありません。",
      listing: "掲載",
      globalScore: "総合スコア",
      createdAt: "作成日時",
      actions: "アクション",
      ...
      noAudits: "まだ監査がありません",
      noAuditsText:
        "最初の掲載を分析してスコアを取得し、高インパクトなアクションを特定し、最適化履歴を作り始めましょう。",
      firstAudit: "最初の掲載を分析",
      viewReport: "レポートを見る",
      relaunchAudit: "監査を再実行",
      delete: "レポートを削除",
      noScore: "まだスコアがありません",
      unavailable: "利用不可",
      activePlan: "高インパクト追跡",
      activePlanText: "パフォーマンス、コンバージョン、収益ポテンシャルをより明確に把握できます。",
      deleteTitle: "この監査レポートを削除しますか？",
      deleteText: "この操作は元に戻せません。",
      cancel: "キャンセル",
      deleting: "削除中...",
      deleted: "監査を削除しました",
      deleteError: "この監査を削除できません。",
      ownerBadge: "オーナー",
      noLastAudit: "最近の監査はありません",
      scoreStatus: "ステータス",
      sourceListing: "元の掲載を見る ↗",
      showLabel: "表示:",
      previous: "前へ",
      next: "次へ",
      pageLabel: "ページ",
  ...
  if (locale === "zh") {
    return {
      ...
      heading: "表现审计",
      subtitle:
        "分析你的房源，并识别能提升预订的高影响力行动。",
      headerDescription:
        "持续追踪房源质量、比较结果，并为下一步优化行动确定优先级。",
      identity: "工作区信息",
      owner: "所有者资料",
      notProvided: "未提供",
      auditsCount: "已完成审计",
      averageScore: "平均分",
      lastAudit: "最近审计",
      improvementPotential: "增长机会",
      improvementPotentialText:
        "通过改进房源可带来的预估增长。",
      estimatedImpact: "预估影响",
      freeLimitReached: "你已达到免费计划上限",
      freeLimitHelper: "升级到 Pro 以解锁无限审计。",
      unlockPro: "升级到 Pro",
      proBadge: "Pro 可用",
      proActive: "Pro 计划已激活",
      creditsActiveLabel: "有效额度",
      creditsAvailableSuffix: "可用审计",
      creditsStatusSubtext: "可立即用于发起新的审计",
      planVersusCreditsHint:
        "这是此工作区的计费层级，而不是你的剩余审计额度（见 Billing）。",
      creditsAvailableLabel: "可用额度",
      noCreditsAvailable: "没有可用额度",
      limitReachedCta: "已达到上限",
      aiInsights: "AI 洞察",
      summaryTitle: "表现摘要",
      summaryText:
        "使用审计历史来识别哪些房源需要立即关注，以及最容易释放转化提升的地方。",
      insightsTitle: "洞察与建议",
      insightsText:
        "从最有可能改善可见性、转化和表现的行动开始。",
      recommendedActions: "推荐行动",
      insightOne: "优化主图",
      insightTwo: "改进房源标题",
      insightThree: "增加更醒目的设施",
      limitedRecommendations: "查看更多深度分析",
      ctaLaunchAudit: "发起审计",
      ctaLaunchAuditLastCredit: "发起审计（最后一个额度）",
      ctaLaunchAuditTwoLeft: "发起审计（剩余 2 个）",
      ctaBuyAudits: "购买审计",
      ctaConsumesCredit: "消耗 1 个额度",
      ctaBuyAuditsHelper: "请在 Billing 页面选择套餐或按次购买。",
      relaunchAuditLastCredit: "重新发起审计（最后一个额度）",
      relaunchAuditTwoLeft: "重新发起审计（剩余 2 个）",
      ctaHelper: "识别能提升预订的关键行动。",
      reportsTitle: "可用报告",
      linkedListingColumn: "关联房源",
      linkedListingHint: "该房源的表现报告",
      showingReportsFor: "当前显示报告：",
      showAllReports: "显示所有报告",
      noReportsForFilteredListing: "此工作区中该房源没有报告。",
      listing: "房源",
      globalScore: "总分",
      createdAt: "创建于",
      actions: "操作",
      ...
      noAudits: "还没有审计",
      noAuditsText:
        "分析你的第一个房源，获取分数，识别高影响力行动，并开始建立优化历史。",
      firstAudit: "分析你的第一个房源",
      viewReport: "查看报告",
      relaunchAudit: "重新发起审计",
      delete: "删除报告",
      noScore: "暂无分数",
      unavailable: "不可用",
      activePlan: "高影响追踪",
      activePlanText: "更清晰地了解表现、转化和收入潜力。",
      deleteTitle: "删除此审计报告？",
      deleteText: "此操作不可撤销。",
      cancel: "取消",
      deleting: "删除中...",
  ...
  if (locale === "ko") {
    return {
      ...
      heading: "성과 감사",
      subtitle:
        "숙소를 분석하고 예약을 늘릴 수 있는 고영향 액션을 식별하세요.",
      headerDescription:
        "시간에 따라 숙소 품질을 추적하고, 결과를 비교하며, 다음 최적화 액션의 우선순위를 정하세요.",
      identity: "워크스페이스 정보",
      owner: "소유자 프로필",
      notProvided: "제공되지 않음",
      auditsCount: "완료된 감사",
      averageScore: "평균 점수",
      lastAudit: "최근 감사",
      improvementPotential: "성장 기회",
      improvementPotentialText:
        "숙소를 개선했을 때 가능한 예상 상승 폭입니다.",
      estimatedImpact: "예상 영향",
      freeLimitReached: "무료 플랜 한도에 도달했습니다",
      freeLimitHelper: "Pro로 업그레이드하여 무제한 감사를 해제하세요.",
      unlockPro: "Pro로 업그레이드",
      proBadge: "Pro에서 사용 가능",
      proActive: "Pro 플랜 활성",
      creditsActiveLabel: "활성 크레딧",
      creditsAvailableSuffix: "사용 가능한 감사",
      creditsStatusSubtext: "새 감사를 바로 시작할 수 있습니다",
      planVersusCreditsHint:
        "이 워크스페이스의 청구 플랜이며, 남은 감사 크레딧이 아닙니다(Billing 참조).",
      creditsAvailableLabel: "사용 가능한 크레딧",
      noCreditsAvailable: "사용 가능한 크레딧이 없습니다",
      limitReachedCta: "한도 도달",
      aiInsights: "AI 인사이트",
      summaryTitle: "성과 요약",
      summaryText:
        "감사 이력을 활용해 어떤 숙소가 즉각적인 주의가 필요한지, 어디에서 가장 쉽게 전환 개선을 얻을 수 있는지 파악하세요.",
      insightsTitle: "인사이트 및 권장사항",
      insightsText:
        "가시성, 전환, 성과를 가장 잘 개선할 수 있는 액션부터 시작하세요.",
      recommendedActions: "권장 액션",
      insightOne: "메인 사진 최적화",
      insightTwo: "숙소 제목 개선",
      insightThree: "더 눈에 띄는 편의시설 추가",
      limitedRecommendations: "더 깊은 분석 보기",
      ctaLaunchAudit: "감사 시작",
      ctaLaunchAuditLastCredit: "감사 시작 (마지막 크레딧)",
      ctaLaunchAuditTwoLeft: "감사 시작 (2개 남음)",
      ctaBuyAudits: "감사 구매",
      ctaConsumesCredit: "크레딧 1개 사용",
      ctaBuyAuditsHelper: "Billing 페이지에서 패키지 또는 건별 결제를 선택하세요.",
      relaunchAuditLastCredit: "감사 다시 시작 (마지막 크레딧)",
      relaunchAuditTwoLeft: "감사 다시 시작 (2개 남음)",
      ctaHelper: "예약을 늘리는 액션을 식별하세요.",
      reportsTitle: "사용 가능한 보고서",
      linkedListingColumn: "연결된 숙소",
      linkedListingHint: "이 숙소의 성과 보고서",
      showingReportsFor: "현재 표시 중:",
      showAllReports: "모든 보고서 보기",
      noReportsForFilteredListing: "이 워크스페이스에서 이 숙소에 대한 보고서가 없습니다.",
      listing: "숙소",
      globalScore: "종합 점수",
      createdAt: "생성일",
      actions: "작업",
      ...
      auditId: "감사 ID",
      noAudits: "아직 감사가 없습니다",
      noAuditsText:
        "첫 숙소를 분석해 점수를 받고, 고영향 액션을 식별하고, 최적화 이력을 만들기 시작하세요.",
      firstAudit: "첫 숙소 분석",
      viewReport: "보고서 보기",
      relaunchAudit: "감사 다시 시작",
      delete: "보고서 삭제",
      noScore: "아직 점수 없음",
      unavailable: "사용 불가",
      activePlan: "고영향 추적",
      activePlanText: "성과, 전환, 수익 잠재력을 더 명확하게 파악합니다.",
      deleteTitle: "이 감사 보고서를 삭제하시겠습니까?",
      deleteText: "이 작업은 되돌릴 수 없습니다.",
      cancel: "취소",
      deleting: "삭제 중...",
      deleted: "감사가 삭제되었습니다",
      deleteError: "이 감사를 삭제할 수 없습니다.",
      ownerBadge: "소유자",
      noLastAudit: "최근 감사 없음",
      scoreStatus: "상태",
      sourceListing: "원본 숙소 보기 ↗",
      showLabel: "표시:",
      previous: "이전",
      next: "다음",
      pageLabel: "페이지",
  ...
  if (locale === "ar") {
    return {
      kicker: "الأداء",
      heading: "عمليات تدقيق الأداء",
      subtitle:
        "حلّل إعلاناتك وحدد الإجراءات ذات الأثر الكبير لزيادة الحجوزات.",
      headerDescription:
        "تابع جودة إعلاناتك بمرور الوقت، وقارن النتائج، وحدد أولويات خطوات التحسين التالية.",
      identity: "هوية مساحة العمل",
      owner: "ملف المالك",
      notProvided: "غير متوفر",
      auditsCount: "عمليات تدقيق مكتملة",
      averageScore: "متوسط النقاط",
      lastAudit: "آخر تدقيق",
      improvementPotential: "فرصة نمو",
      improvementPotentialText:
        "تقدير للمكاسب الممكنة عند تحسين إعلانك.",
      estimatedImpact: "الأثر التقديري",
      freeLimitReached: "لقد بلغت حد الخطة المجانية",
      freeLimitHelper: "قم بالترقية إلى Pro لفتح عمليات تدقيق غير محدودة.",
      unlockPro: "الترقية إلى Pro",
      proBadge: "متاح على Pro",
      proActive: "خطة Pro نشطة",
      creditsActiveLabel: "الأرصدة النشطة",
      creditsAvailableSuffix: "عمليات تدقيق متاحة",
      creditsStatusSubtext: "جاهزة للاستخدام فورًا لإطلاق عمليات تدقيق جديدة",
      planVersusCreditsHint:
        "هذه هي فئة الفوترة الخاصة بمساحة العمل هذه، وليست رصيدك المتبقي من عمليات التدقيق (انظر Billing).",
      creditsAvailableLabel: "الأرصدة المتاحة",
      noCreditsAvailable: "لا توجد أرصدة متاحة",
      limitReachedCta: "تم بلوغ الحد",
      aiInsights: "رؤى الذكاء الاصطناعي",
      summaryTitle: "ملخص الأداء",
      summaryText:
        "استخدم سجل التدقيق لتحديد الإعلانات التي تستحق اهتمامًا فوريًا وأين يمكن تحقيق مكاسب التحويل بسهولة أكبر.",
      insightsTitle: "الرؤى والتوصيات",
      insightsText:
        "ابدأ بالإجراءات الأكثر احتمالًا لتحسين الظهور والتحويل والأداء.",
      recommendedActions: "الإجراءات الموصى بها",
      insightOne: "تحسين الصور الرئيسية",
      insightTwo: "تحسين عنوان الإعلان",
      insightThree: "إضافة مرافق أكثر وضوحًا",
      limitedRecommendations: "استكشف تحليلاً أعمق",
      ctaLaunchAudit: "إطلاق تدقيق",
      ctaLaunchAuditLastCredit: "إطلاق تدقيق (آخر رصيد)",
      ctaLaunchAuditTwoLeft: "إطلاق تدقيق (متبقي 2)",
      ctaBuyAudits: "شراء عمليات تدقيق",
      ctaConsumesCredit: "يستهلك رصيدًا واحدًا",
      ctaBuyAuditsHelper: "اختر باقة أو الدفع لكل تدقيق من صفحة Billing.",
      relaunchAuditLastCredit: "إعادة إطلاق التدقيق (آخر رصيد)",
      relaunchAuditTwoLeft: "إعادة إطلاق التدقيق (متبقي 2)",
      ctaHelper: "حدد الإجراءات التي تزيد حجوزاتك.",
      reportsTitle: "التقارير المتاحة",
      linkedListingColumn: "الإعلان المرتبط",
      linkedListingHint: "تقرير الأداء لهذا الإعلان",
      showingReportsFor: "عرض التقارير لـ",
      showAllReports: "عرض جميع التقارير",
      noReportsForFilteredListing: "لا توجد تقارير لهذا الإعلان في مساحة العمل هذه.",
      listing: "الإعلان",
      ...
      noAudits: "لا توجد عمليات تدقيق بعد",
      noAuditsText:
        "حلّل إعلانك الأول للحصول على نتيجة، وتحديد الإجراءات ذات الأثر الكبير، وبدء سجل التحسين الخاص بك.",
      firstAudit: "حلّل إعلانك الأول",
      viewReport: "عرض التقرير",
      relaunchAudit: "إعادة إطلاق التدقيق",
      delete: "حذف التقرير",
      noScore: "لا توجد نتيجة بعد",
      unavailable: "غير متاح",
      activePlan: "متابعة عالية الأثر",
      activePlanText: "رؤية أوضح للأداء والتحويل وإمكانات الإيرادات.",
      deleteTitle: "هل تريد حذف تقرير التدقيق هذا؟",
      deleteText: "هذا الإجراء غير قابل للتراجع.",
      cancel: "إلغاء",
      deleting: "جارٍ الحذف...",
      deleted: "تم حذف التدقيق",
      deleteError: "تعذر حذف هذا التدقيق.",
      ownerBadge: "المالك",
      noLastAudit: "لا يوجد تدقيق حديث",
      scoreStatus: "الحالة",
      sourceListing: "عرض الإعلان الأصلي ↗",
      showLabel: "إظهار:",
      previous: "السابق",
      next: "التالي",
      pageLabel: "الصفحة",
