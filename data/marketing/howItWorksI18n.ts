export const howItWorksI18n = {
  ...
  pt: {
    ...
    hero: {
      ...
      reassurance: "Sem compromisso • Resultados em menos de 30 segundos",
      proof: "+2.000 anúncios analisados • Resultados concretos e mensuráveis",
  ...
  nl: {
    ...
    hero: {
      ...
      reassurance: "Geen verplichtingen • Resultaten binnen 30 seconden",
      proof: "+2.000 geanalyseerde advertenties • Meetbare concrete resultaten",
