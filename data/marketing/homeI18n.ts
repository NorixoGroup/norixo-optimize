export const homeI18n = {
  en: {
    ...
    beforeAfter: {
      ...
      reportSummary: "Norixo centralizes key signals in a clear report: current level, priority blockers and estimated impact.",
  ...
  fr: {
    ...
    beforeAfter: {
      ...
      reportSummary: "Norixo centralise les signaux clés dans un rapport clair : niveau actuel, freins prioritaires et impact estimé.",
  ...
  es: {
    ...
    beforeAfter: {
      ...
      reportSummary: "Norixo centraliza las señales clave en un informe claro: nivel actual, frenos prioritarios e impacto estimado.",
  ...
  de: {
    ...
    beforeAfter: {
      ...
      reportSummary: "Norixo bündelt wichtige Signale in einem klaren Bericht: aktueller Stand, priorisierte Hürden und geschätzter Effekt.",
  ...
  pt: {
    ...
    beforeAfter: {
      ...
      reportSummary: "O Norixo reúne os sinais essenciais num relatório claro: nível atual, bloqueios prioritários e impacto estimado.",
  ...
  nl: {
    ...
    beforeAfter: {
      ...
      reportSummary: "Norixo bundelt alle belangrijke signalen in één duidelijk rapport: huidig niveau, belangrijkste blokkades en geschatte impact.",
  ...
  it: {
    ...
    beforeAfter: {
      ...
      reportSummary: "Norixo centralizza i segnali chiave in un report chiaro: livello attuale, blocchi prioritari e impatto stimato.",
  ...
  ja: {
    ...
    beforeAfter: {
      ...
      reportSummary: "Norixoは、現在の水準、優先的な障害、推定インパクトなどの重要シグナルを明確なレポートに集約します。",
  ...
  zh: {
    ...
    beforeAfter: {
      ...
      reportSummary: "Norixo 将关键信号集中到一份清晰报告中：当前水平、优先障碍和预估影响。",
  ...
  ko: {
    ...
    beforeAfter: {
      ...
      reportSummary: "Norixo는 현재 수준, 우선 장애요인, 예상 영향과 같은 핵심 신호를 명확한 보고서에 모아줍니다.",
  ...
  ar: {
    ...
    beforeAfter: {
      ...
      reportSummary: "يجمع Norixo الإشارات الأساسية في تقرير واضح: المستوى الحالي، العوائق ذات الأولوية، والأثر التقديري.",
