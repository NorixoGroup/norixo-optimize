...
const ids = { workspace: "00000000-0000-4000-8000-000000000001", run: "00000000-0000-4000-8000-000000000002", promotion: "00000000-0000-4000-8000-000000000003", domain: "00000000-0000-4000-8000-000000000004", opportunity: "00000000-0000-4000-8000-000000000005", actor: "00000000-0000-4000-8000-000000000006" };
...
async function main() {
  ...
  const form = fixture({ channel: "contact_form", contacts: [verified()], resolution: resolved([emailCandidate]) }); await enter(form); const c = await cycle(form, "contact_form"); assert.deepEqual(c.reasonCodes, ["CONTACT_FORM_EXECUTION_PENDING"]); assert.equal(form.counters.forms, 0);
