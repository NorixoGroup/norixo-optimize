import { listBacklinkOutreachExpiredResponseDeadlines } from "../lib/backlinks/services/outreachExpiredResponseDeadlineSelectorService";
...
async function main() {
  ...
  const service = listBacklinkOutreachExpiredResponseDeadlines({ rpc: rpc as never });
  ...
  }), "Service must return the minimal expired response deadline projection.");

  console.log("PASS — Backlink outreach expired response deadline selector service smoke");
}
