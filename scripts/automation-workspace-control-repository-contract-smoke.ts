...
async function main(): Promise<void> {
  ...
  assert(source.includes("patch.backlinks_enabled = input.backlinksEnabled;"), "Update payload must include backlinks_enabled when supplied");
  assert(
    source.includes("patch.backlink_outreach_schedule_apply_enabled =") &&
