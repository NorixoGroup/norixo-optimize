...
begin
  ...
  if not (
    ...
    raise exception 'EXPIRED_RESPONSE_DEADLINE_SELECTOR_FORBIDDEN';
  end if;
...
grant execute on function public.list_backlink_outreach_expired_response_deadlines(uuid, timestamptz, integer) to authenticated;
