...
export type AutomationTask = { id: string; workspaceId: string; runId: string; dependsOnTaskId: string | null; system: AutomationSystem; taskKind: string; taskKey: string; status: AutomationTaskStatus; priority: number; scheduledAt: string; availableAt: string; claimedAt: string | null; startedAt: string | null; heartbeatAt: string | null; leaseExpiresAt: string | null; completedAt: string | null; failedAt: string | null; cancelledAt: string | null; workerId: string | null; attemptCount: number; maxAttempts: number; backoffBaseSeconds: number; input: Json; output: Json | null; errorCode: string | null; errorMessage: string | null; createdAt: string; updatedAt: string };
export type CreateAutomationTaskInput = { workspaceId: string; runId: string; dependsOnTaskId?: string | null; system: AutomationSystem; taskKind: string; taskKey: string; priority: number; scheduledAt: string; availableAt: string; maxAttempts: number; backoffBaseSeconds: number; input: Json };
