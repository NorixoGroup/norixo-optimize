...
export type LinkedInInteractionType = "connection_invitation_sent" | "connection_accepted" | "connection_rejected" | "connection_withdrawn" | "connection_expired" | "message_sent" | "reply_confirmed";
export type LinkedInInteraction = { id: string; outreach_id: string; contact_id: string; actor_user_id: string; interaction_type: LinkedInInteractionType; occurred_at: string; target_profile_url: string; source: string; idempotency_key: string; created_at: string };
type GenericInteractionRpc = Database["public"]["Functions"]["record_backlink_manual_linkedin_interaction"];
type GenericInteractionRpcArgs = GenericInteractionRpc["Args"];
type GenericInteractionRpcReturn = GenericInteractionRpc["Returns"][number];
type MessageSentRpc = Database["public"]["Functions"]["record_backlink_manual_linkedin_message_sent"];
