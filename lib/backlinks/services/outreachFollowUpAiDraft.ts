...
export function buildBacklinkOutreachFollowUpAiPrompt(
  ...
  return [
    ...
    "- Preserve the concrete editorial purpose of the previous outbound: briefly remind the recipient what specific resource, citation, reference, review, or placement was proposed when that purpose is present in the supplied previous email.",
    "- The follow-up must remain meaningfully connected to that specific prior proposal instead of degrading into a generic request for thoughts, feedback, or whether they had a chance to consider it.",
    "- Do not ask for feedback or thoughts unless the previous outbound explicitly asked for feedback or thoughts.",
    "- Keep the follow-up concise, professional, natural, and human.",
    "- Avoid generic or mechanical outreach language.",
    "- Start directly from the concrete reason for the follow-up. Do not add generic pleasantries or filler before the purpose of the message.",
    '- Do not use stock openings or closings such as "I hope this message finds you well", "I hope you\'re well", "I wanted to follow up", "just checking in", or "I look forward to hearing from you".',
    "- Prefer a direct contextual opening that identifies the specific resource or proposal from the previous outbound.",
    "- When the previous outbound supplied a concrete Norixo resource URL and repeating it would help the recipient act on the proposal, include that URL naturally in the follow-up.",
    "- The call to action must follow from the actual prior proposal. Ask about the specific citation, resource, reference, review, or placement when appropriate; do not replace it with a generic request for thoughts, feedback, or consideration.",
    "- For the first follow-up, add no new sales pitch. Briefly remind the recipient why the specific resource was relevant to their page, then make one clear low-pressure call to action.",
